...
var (
	...
	//LL, mainPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 224), bigOne)
...
var MainNetParams = Params{
	...
	*/
	...
	// target = coefficient * 256^(exponent – 3), 前2位十六进制数字为指数，接下来得6位为系数
	// 0x1d00ffff: coefficient=00ffff; exponent=1d
	// target = 00ffff * 0x0100^(1d - 3)
	//PowLimitBits:             0x1d00ffff,
	PowLimitBits:     0x1f0fffff, // 0x000fffff00000000000000000000000000000000000000000000000000000000
	BIP0034Height:    227931,     // 000000000000024b89b42a942fe0d9fea3bb44ab7bd1b19115dd6a759c0808b8
	BIP0065Height:    388381,     // 000000000000000004c2b624ed5d7756c508d90fd0da2c7c679febfa6c4735f0
	BIP0066Height:    363725,     // 00000000000000000379eaa19dce8c9b722d46ae6a57c2f1a988119488b50931
	CoinbaseMaturity: 100,
	//这个参数决定了多少个block以后比特币的奖励（补贴，挖矿奖励)会减半。
	// 这个参数结合初始奖励（比如比特币50）基本可以估算全网总的货币产量（比如比特币的2100万）
	//一个等比数列求和公式就可以计算货币总量 50(1/(1 - 0.5))*210000=2100万btc
	...
	*/
	...
	// Address encoding magics
	// 比特币地址前缀对照表：https://en.bitcoin.it/wiki/List_of_address_prefixes
